...
GENERATED_NOTE = (
    ...
    "Run `agentry emit agents-md` to refresh; do not hand-edit. -->"
)
...
#
# ``agentry emit triggers`` writes a small, marker-delimited block into each target's memory file
...
_TRIGGERS_MANAGED_NOTE = (
    ...
    "Run `agentry emit triggers` to refresh. -->"
)
